...
async function seed() {
    try {
        ...
        await Company_model_1.Company.deleteMany({});
        await Challenge_model_1.Challenge.deleteMany({});
        ...
        for (const c of companiesData) {
            ...
            const companyProfile = await Company_model_1.Company.create({
        ...
        const categories = ['web', 'ai', 'blockchain', 'mobile', 'web', 'cloud', 'blockchain', 'design', 'other', 'web'];
        for (let i = 1; i <= 10; i++) {
            ...
            await Company_model_1.Company.findByIdAndUpdate(company._id, { $inc: { totalChallenges: 1 } });
        }
        ...
        for (let i = 0; i < 5; i++) {
            ...
            await Submission_model_1.Submission.create({
