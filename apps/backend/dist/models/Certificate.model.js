...
const certificateSchema = new mongoose_1.Schema({
    ...
    submissionId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Submission', required: true },
...
exports.Certificate = mongoose_1.default.models.Certificate || mongoose_1.default.model('Certificate', certificateSchema);
