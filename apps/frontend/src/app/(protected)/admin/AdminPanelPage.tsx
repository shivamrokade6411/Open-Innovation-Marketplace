                    ...
                    <tr key={user._id} className="hover:bg-white/[0.02] transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span className={`px-2.5 py-0.5 rounded-full text-xs font-semibold uppercase ${
                          user.isVerified ? 'bg-emerald-500/10 text-emerald-400' : 'bg-yellow-500/10 text-yellow-500'
                        }`}>
                      ...
                      <td className="px-6 py-4 text-right flex justify-end gap-2">
                        {c.status === 'active' ? (
                          <button
                            ...
                            className="bg-yellow-500/10 hover:bg-yellow-500/20 text-yellow-500 border border-yellow-500/20 text-xs px-3 py-1.5 rounded-lg transition"
                          >
                            Suspend (Draft)
                          </button>
                        ) : (
                          <button
                            ...
                            className="bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-500 border border-emerald-500/20 text-xs px-3 py-1.5 rounded-lg transition"
                          >
                            Approve Live
                          </button>
                        )}
